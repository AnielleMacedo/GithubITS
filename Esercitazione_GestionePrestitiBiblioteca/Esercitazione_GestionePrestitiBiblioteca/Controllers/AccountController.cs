...
namespace Esercitazione_GestionePrestitiBiblioteca.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //proprieta per i ruoli
        private ApplicationDbContext context;


        public AccountController()
        {
            //tb add aki q antes era vazio
        ...
        public async Task<ActionResult> RegisterRole(RegisterViewModel model, ApplicationUser user)
        {
            ...
            //assegno ruolo per utente qui
            await this.UserManager.AddToRoleAsync(updatedId, model.Name);

            return RedirectToAction("Index", "Home");//em caso de sucesso
        }
